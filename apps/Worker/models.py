...
class Worker(models.Model):
    ...
    id_Discapacidad = models.ForeignKey(Discapacidad, null=True,verbose_name='Discapacidad', on_delete=models.PROTECT)
    id_Tipo_discapacidad = models.ForeignKey(Tipodiscapacidad, null=True,blank=True,verbose_name='Indique la que corresponda', on_delete=models.PROTECT)
